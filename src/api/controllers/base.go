...
func (server *Server) Initialize(Dbdriver, DbUser, DbPassword, DbPort, DbHost, DbName string) {
	...
	server.DB.Debug().AutoMigrate(&models.Parent{}, &models.Child{}, &models.ParentVisit{}, &models.ChildVisit{}, &models.ParentDownload{}, &models.ChildDownload{}, &models.Url{}, &models.NSFWUrl{}) //database migration
