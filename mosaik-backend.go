...
// 	//router.HandleFunc("/parents/", GetParents).Methods("GET")
// 	router.HandleFunc("/parents/{id}", GetParent).Methods("GET")
// 	router.HandleFunc("/parents/", AddParent).Methods(http.MethodPost)
...
// 	if err != nil {
// 		fmt.Fprintf(w, "Masukkan data dengan lengkap!")
// 		return //add this return, otherwise continue the function with the error
// 	}
// 	err = json.Unmarshal(reqBody, &newParent)
// 	if err != nil {
// 		fmt.Fprintf(w, "json format invalid")
// 		return
// 	}
// 	result := db.Create(&newParent) // pass pointer of data to Create
